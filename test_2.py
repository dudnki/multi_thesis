...
CKPT_PATH     = "classification/classification_model.pth"       # 선형프로브 가중치 저장/불러오기 경로 (.pt)
SEED          = 42
...
def default_prompts_for(classes):
    ...
    # 필요 시 특정 클래스 커스텀 덮어쓰기 예시 (여기에 네가 확장해서 넣으면 더 좋음)
    ...
    elif "Miniature Pinscher" in d:
        d["Miniature Pinscher"] = [
            "Miniature Pinscher has a small compact body with a square outline.",
            "Miniature Pinscher shows a smooth short coat that lies close to the skin.",
            "Miniature Pinscher has a wedge-shaped head with a pronounced stop.",
            "Miniature Pinscher displays dark oval eyes with a keen alert expression.",
            "Miniature Pinscher has high-set ears that are naturally erect or cropped in some dogs.",
            "Miniature Pinscher carries a high-set tail that is straight and held proudly.",
            "Miniature Pinscher commonly appears in black and tan solid red or stag red colors.",
            "Miniature Pinscher has a level topline and a slightly arched neck.",
            "Miniature Pinscher shows a narrow clean muzzle with tight lips.",
            "Miniature Pinscher has small cat-like feet with strong compact toes.",
            "Miniature Pinscher moves with a high-stepping hackney-like gait.",
            "Miniature Pinscher has a deep but not broad chest reaching to the elbows.",
            "Miniature Pinscher shows well-angulated hindquarters and straight forelegs.",
            "Miniature Pinscher has fine glossy hair that emphasizes its clean outline.",
            "Miniature Pinscher presents a confident spirited carriage at rest and in motion.",
            "Miniature Pinscher has a short back and well-sprung ribs matching its square proportions."
        ]
